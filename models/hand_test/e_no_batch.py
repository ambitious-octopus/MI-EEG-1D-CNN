...
from model_set.models import HopefullNet, HopefullNet_HBN
import numpy as np
...
save_path = os.path.join("/dataset/saved_models", "roi_e_no_batch")
os.mkdir(save_path)

# Load data
channels = Utils.combinations["e"] #["FC1", "FC2"], ["FC3", "FC4"], ["FC5", "FC6"]]
